...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/thomasraith/SideProjects/HomeOrganizer/flask-backend'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/thomasraith/SideProjects/HomeOrganizer/flask-backend/bin/deactivate.nu'
